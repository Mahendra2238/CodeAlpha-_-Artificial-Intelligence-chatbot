		...
		chatbox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (gtext.toLowerCase().contains("hi") || gtext.toLowerCase().contains("hello")) {
					...
					switch (rand) {
						case 1:
							bot("I'm not sure I understand. Could you please rephrase that?");
							break;
						case 2:
							bot("That's an interesting topic! Can you tell me more about it?");
							break;
						case 3:
							bot("I'm always eager to learn. What else can you share about that?");
							break;
						default:
							bot("I'm a chat bot with limited knowledge. Is there a specific topic you'd like to discuss?");
					}
				}
			}
		});
